...
{ 
 ...
 $sql="insert into fregister(fid,password) values('$uname','$password');"; 
...
<body>
<a href="flogin.php"><button style="float: right; "class="w3-button w3-red w3-round-large">Go back >></button></a>
