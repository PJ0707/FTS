...
input" type="text" autocomplete="off" placeholder="file_Name" name="file_name">
 ...
 <p style="paddingleft: 35%;background colour:black;" ><input type="file"  accept=".jpg,.doc,.pdf,.pptx,.jfif,.png,.docx" max-size="50000" name="file"></p>
<p style="color:red">*file size should not exceed 50mb</p>
<p style="color:red">*only .jpg,.doc,.pdf,.jfif,.png,.pptx,.docx files accepted</p>
